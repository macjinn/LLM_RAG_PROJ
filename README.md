...
- **HybridRetriever**을 사용하여 더 나은 탐색 알고리즘 제공 (백터유사도 + 키워드매칭) 
...
- **구현**: `sentence-transformers/all-MiniLM-L6-v2` 토크나이저를 활용하여 금융 상품 설명을 벡터로 변환 후 저장
